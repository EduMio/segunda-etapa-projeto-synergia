              ...
              {isEditing ? (
                    ...
                    <Grid>
                      <FormControl component="fieldset">
                        ...
                        >
                          ...
                          <FormControlLabel value="prefiro-nao-dizer" control={<Radio />} label="Prefiro não informar" />
                        </RadioGroup>
                      </FormControl>
                    </Grid>
                ...
                <Grid container spacing={2}>
                  <Grid>
                    ...
                    <Typography>{userData.name || 'Sem informação'}</Typography>
                  </Grid>
                  
                  <Grid>
                    <Typography variant="h6">Email</Typography>
                    <Typography>{userData.email || 'Sem informação'}</Typography>
                  </Grid>
                  
                  <Grid>
                    <Typography variant="h6">Aniversário</Typography>
                    <Typography>{userData.birthday || 'Sem informação'}</Typography>
                  </Grid>
                  
                  <Grid>
                    <Typography variant="h6">Gênero</Typography>
                    <Typography>{userData.gender || 'Sem informação'}</Typography>
                  </Grid>
                  
                  <Grid>
                    <Typography variant="h6">Empresa</Typography>
                    <Typography>{userData.company || 'Sem informação'}</Typography>
                  </Grid>
